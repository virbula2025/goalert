...
// TestTelnyxSMSAck tests that an alert can be acknowledged via SMS.
func TestTelnyxSMSAck(t *testing.T) {
	t.Parallel()
	...
	// Reply '4' to Acknowledge
	h.TelnyxMock().SendSMS(d.Number, h.Phone("GoAlert"), "4")

	// Expect Ack confirmation
