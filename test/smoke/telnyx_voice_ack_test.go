...
// TestTelnyxVoiceAck tests acknowledging an alert via a Telnyx voice call.
func TestTelnyxVoiceAck(t *testing.T) {
	t.Parallel()
	...
	// 2. Verify greeting and press '4' to Ack
	call.ThenExpect("Hello! This is GoAlert").
		ThenExpect("testing").
		ThenPress("4").
